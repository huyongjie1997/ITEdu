...
class CourseInfo(models.Model):
    ...
    detail = UEditorField(verbose_name='课程详情',
	                         ...
	                         height=400,
	                         toolbars='full',
	                         imagePath='images/ueditor/',
	                         filePath='files/ueditor/',
...
class VideoInfo(models.Model):
    ...
    url = models.URLField(default='',verbose_name="视频链接",max_length=200)
    video_source = models.FileField(upload_to='video/',max_length=200,verbose_name="视频资源",default='')
    lessoninfo = models.ForeignKey(LessonInfo,on_delete=models.CASCADE,verbose_name="所属章节")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")

    def __str__(self):
        #return self.name
        return "%s , %d" % (self.name, self.study_time)
